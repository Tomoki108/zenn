---
title: "AtCoder Beginer Contest 370~382 Dまでの要点・解答（Go）"
emoji: "🦁"
...
- k 体目のモンスターを処理する時の経験値の変動は、そのモンスターが偶数体目の討伐対象か、奇数対目の討伐対処かによる。(倒す倒さないの選択もあるが。)k-1 対目まで処理した時点で、偶数体討伐済みか奇数体討伐済みかと言うこともできる。
