---
title: "AtCoder Beginer Contest 317~350 Dまでの要点・解答（Go）"
emoji: "🦁"
...
- ウィンドウ幅が大きくなるほど、必要な行数が減る（**単調性**）。M 行に収まるようなウィンドウ幅を**二分探索**できる。
  ...
  - min は、最も長い単語のサイズ。max は、単語のサイズの総和+`(N-1)*1`のスペース。(**log max が二分探索の計算コスト**。)
...
- 「DFS の計算量は $O(V + E)$ （V: vertex, E: edgs）」と言われるが、これは**始点を固定した**、**バックトラックなしの**、DFS の計算量である。
...
## [A - ](https://atcoder.jp/contests/abc315/tasks/abc315_a)
...
## [B - ](https://atcoder.jp/contests/abc315/tasks/abc315_b)
...
## [C - ](https://atcoder.jp/contests/abc315/tasks/abc315_c)
...
## [D - ](https://atcoder.jp/contests/abc315/tasks/abc315_d)
