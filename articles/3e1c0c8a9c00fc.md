---
title: "AtCoder Beginer Contest 323~350 Dまでの要点・解答（Go）"
emoji: "🦁"
...
- $(10^6)^2 = 10^{12} （13桁）$であるため、10^6 までの数が平方根としてあり得るので、平方数の列挙は間に合う。
...
## [B - ](https://atcoder.jp/contests/abc323/tasks/abc323_b) / 整数問題
