...
今回のバッチ実装は Goroutine や Channel、WaitGroup、Semaphore、Buffer などをふんだんに活用したものになっています。個人的に前職ではずっと PHP を書いており、こういったものを実装してみたくて CastingONE に転職した背景があます。作っていて非常に楽しく、Go での並列処理の書きやすさに感動しておりました。
